...
-   The code for A2 was used as a starting point, making changes to several files, and removing some, to remove all uses of SimpleKit.
-   It wasn't made clear whether or not to hide "Values:" when no chart is selected (or more than 1 is), so I hid it, since it feel logical.
